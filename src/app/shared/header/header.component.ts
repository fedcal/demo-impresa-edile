  ...
  template: `
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home Edilcasa Costruzioni">
          <span class="brand__icon" aria-hidden="true">🏗️</span>
          <span class="brand__text">Edilcasa</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          ...
          <a routerLink="/portfolio" routerLinkActive="is-active">Portfolio</a>
          <a routerLink="/preventivo" routerLinkActive="is-active" class="cta">Preventivo gratuito</a>
        </nav>
      </div>
    </header>
  `,
