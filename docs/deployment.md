...
URL: `https://impresa-edile.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `impresa-edile.demo.federicocalo.dev`
...
- Output directory: `dist/impresa-edile/browser`
...
URL: `https://fedcal.github.io/federico-demo-impresa-edile/`
...
- `base: /federico-demo-impresa-edile/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `impresa-edile-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   impresa-edile-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `impresa-edile-docs.federicocalo.dev`
