...
hero:
  name: "Demo Impresa Edile"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://impresa-edile.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-impresa-edile
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Impresa Edile.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Impresa Edile** in Italia.
...
Il mercato italiano delle PMI per **Impresa Edile** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:impresa-edile
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-impresa-edile)
